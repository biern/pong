YUI.add("simulation", function (Y) {
  ...
  var Simulation = Y.namespace("Pong").Simulation =
	...
	client.on('server:gameSnapshot', Y.bind(this._onGameSnapshot, this));
	client.on('server:gameBoardInfo', Y.bind(this._onGameBoardInfo, this));
	client.on('server:playerInfo', Y.bind(this._onPlayerInfo, this));
